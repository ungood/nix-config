...
machine.succeed("su - ungood -c 'which direnv'")
...
machine.succeed("su - ungood -c 'cd /tmp && echo \"export TEST_VAR=hello_direnv\" > .envrc && direnv allow . && direnv export json >/dev/null'")
